...
%--------------------------------------------------------------------------
\chapter{Passacaglia for String Quartet}

%--------------------------------------------------------------------------
\begin{figure}[h!]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_1.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_2.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_3.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_4.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_5.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_6.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_7.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_8.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_9.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_10.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_11.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_12.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_13.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_14.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_15.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_16.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_17.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_18.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_19.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_20.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_21.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_22.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_23.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_24.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_25.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_26.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_27.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_28.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_29.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_30.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_31.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_32.pdf}
\end{figure}

%--------------------------------------------------------------------------
\begin{figure}[htbp]
    \centering
	\includegraphics[width=6.5in]{figures/Passacaglia_33.pdf}
\end{figure}
