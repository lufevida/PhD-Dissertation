...
%--------------------------------------------------------------------------
\begin{itemize}
	\item Differentiate between foldings
	\item Add MOF discussion
	\item Add MOF example
	\item Add Mead
	\item Add percussion key
	\item Add more musical examples
	\item Engrave images
\end{itemize}

%--------------------------------------------------------------------------
\begin{verbatim}
Use retrograde to preserve the partition scheme.

a b c d e f g h i j k l
  a   b c     d   e   f
l   k     j i   h   g

(a l f j e c  k g i h d  b)
(0 7 2 9 4 11 6 1 8 3 10 5)

S = {0, 5, 11, 10, 4, 2, 1, 3, 8, 9, 6, 7}

Solution 5:

     7  0  6  5  11 9  8  10 3  4  1  2  | 2  1  4  3  10 8  9  11 5  6  0  7  
5  |    0     5  11       10    4     2  |    1     3     8  9        6     7  | 5
29 | 7     6        9  8     3     1     | 2     4     10       11 5     0     | 5

Just mapping to cycles is not enough.
