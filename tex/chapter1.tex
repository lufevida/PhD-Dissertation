...
%TODO: add discussion about different definitions of folding here
...
%--------------------------------------------------------------------------
%TODO Differentiate between foldings
%TODO Add MOF discussion
%TODO Add MOF example
%TODO Add Mead
...
\begin{example}
	...
	\noindent In particular, the lower row of the partition scheme is retrograded in regard to the upper row. Extracting permutation cycles from Eq.~\ref{eq:mof} results in the permutation $P = (0 \; 11 \; 5 \; 9 \; 4 \; 2 \; 10 \; 6 \; 8 \; 7 \; 3 \; 1)$. The permutation $P$ can be matched against $RT_7I = (0 \; 7 \; 2 \; 9 \; 4 \; 11 \; 6 \; 1 \; 8 \; 3 \; 10 \; 5)$, for example, to obtain a series, since both $P$ and $RT_7I$ have a single cycle of length 12. This series then is $S = \{0, 5, 11, 10, 4, 2, 1, 3, 8, 9, 6, 7\}$. This construction yields a $12 \times 24$ the following combination matrix of self derivation where the columns are are $[]$:
	...
	\noindent Not every partition scheme affords permutation cycles that can be matched to 
...
a b c d e f h g i j k l
h i     j       k l
    a b   c d e     f g

(a h d b i k f c) (e j l g)    

a b c d e f h g i j k l
g h     i j     k l
    a b     c d     e f

(a g c) (b h d) (e i k)  (f j m)
(0 4 8) (1 5 9) (2 6 10) (3 7 11)

S = {0, 1, 8, 9, 2, 3, 4, 5, 6, 7, 10, 11}
\end{verbatim}
