...
This paragraph generates a list of references and should be ignored.
\noindent
\cite{Aigner2007}
\cite{AlegantLofthouse2002}
\cite{ArnoldHair1976}
\cite{Babbitt1962}
\cite{Babbitt1970}
\cite{Babbitt1973}
...
\cite{Batstone1972a}
\cite{Batstone1972b}
\cite{BazelowBrickle1976a}
\cite{BazelowBrickle1979}
\cite{DummitFoote2004}
\cite{Fennelly1969}
\cite{FripertingerLackner2015}
\cite{Gauldin1977}
\cite{Howe1965}
\cite{Ilomaki2008}
\cite{Kowalski1986}
...
\cite{Morris1982}
\cite{Morris1987}
\cite{MorrisStarr1974}
\cite{MorrisStarr1977}
\cite{MorrisStarr1978}
\cite{Rahn1975}
\cite{Rahn1976}
\cite{Reiner1985}
\cite{Rothgeb1967}
