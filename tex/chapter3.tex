...
%Even with several threads running concurrently, however, computing all $4 \times 48$ combination matrices for a 12-tone row takes a significant amount of time.
...
\caption[Using self-derivation with an octatonic scale.]{Using self-derivation to map an 8-tone row to an octatonic scale.}
\label{fig:quartet}
\end{figure}
