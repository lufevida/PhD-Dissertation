...
% TODO Music has become an almost arbitrary matter, and composers will no longer be bound
...
%--------------------------------------------------------------------------
Whenever the context is clear, we shall drop quotient notation and subscripts. In most
